...
?>
<form action="index.php?controller=index&action=save" method="post" enctype="multipart/form-data">
  ...
  <?php endif; ?>
        ...
        <footer>
            <div class="submit_link">
                ...
                <input type="button" value="Cancel" onclick="document.location='index.php?controller=index&action=index'"/>
            </div>
        </footer>
</form>
